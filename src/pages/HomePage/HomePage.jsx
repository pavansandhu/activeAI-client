      ...
      <section className="background__section">
        <div className="background__section-text">
          ...
          <p className="background__text">
            ...
            to stay fit. At ActiveAI we help you build structured workout plans
            that make the most of the precious time you have to workout.{" "}
          </p>
          <p className="background__text">
            We specialize in cycling, running and swimming workouts. We can
            cater to seasoned athletes or to those just wanting to try out a new
            sport but don't know where to start.
          </p>
        </div>
      </section>
    </>
